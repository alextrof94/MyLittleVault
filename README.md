...
```
Переводы строк (фактические, а не написанные "\r\n") посреди строкового значения ломают спецификацию JSON. Сделано, чтобы JSON был более читабельным. В любом случае, можно этим просто не пользоваться, для совместимости с другими программами.
